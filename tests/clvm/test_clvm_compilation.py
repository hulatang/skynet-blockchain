...
wallet_program_files = set(
    [
        "skynet/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "skynet/wallet/puzzles/cc.clvm",
        "skynet/wallet/puzzles/skynetlisp_deserialisation.clvm",
        "skynet/wallet/puzzles/rom_bootstrap_generator.clvm",
        "skynet/wallet/puzzles/generator_for_single_coin.clvm",
        "skynet/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "skynet/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "skynet/wallet/puzzles/lock.inner.puzzle.clvm",
        "skynet/wallet/puzzles/p2_conditions.clvm",
        "skynet/wallet/puzzles/p2_delegated_conditions.clvm",
        "skynet/wallet/puzzles/p2_delegated_puzzle.clvm",
        "skynet/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "skynet/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "skynet/wallet/puzzles/p2_puzzle_hash.clvm",
        "skynet/wallet/puzzles/rl_aggregation.clvm",
        "skynet/wallet/puzzles/rl.clvm",
        "skynet/wallet/puzzles/sha256tree_module.clvm",
        "skynet/wallet/puzzles/singleton_top_layer.clvm",
        "skynet/wallet/puzzles/did_innerpuz.clvm",
        "skynet/wallet/puzzles/decompress_puzzle.clvm",
        "skynet/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "skynet/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "skynet/wallet/puzzles/block_program_zero.clvm",
        "skynet/wallet/puzzles/test_generator_deserialize.clvm",
        "skynet/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "skynet/wallet/puzzles/p2_singleton.clvm",
        "skynet/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "skynet/wallet/puzzles/pool_member_innerpuz.clvm",
        "skynet/wallet/puzzles/singleton_launcher.clvm",
        "skynet/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["skynet/wallet/puzzles/create-lock-puzzlehash.clvm", "skynet/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "skynet/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to skynet/wallet/puzzles, but not added to `wallet_program_files`
        """

...
from skynet.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            sp = farmer_protocol.NewSignagePoint(
                std_hash(b"1"), std_hash(b"2"), std_hash(b"3"), uint64(1), uint64(1000000), uint8(2), std_hash(b"4")
            )

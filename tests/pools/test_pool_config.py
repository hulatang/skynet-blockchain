...
from skynet.pools.pool_config import PoolWalletConfig
from skynet.util.config import load_config, save_config, create_default_skynet_config
...
def test_pool_config():
    ...
    create_default_skynet_config(test_root, ["config.yaml"])

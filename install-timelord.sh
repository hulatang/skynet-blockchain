...
THE_PATH=$(python -c 'import pkg_resources; print( pkg_resources.get_distribution("skynetvdf").location)' 2>/dev/null)/vdf_client
SKYNETVDF_VERSION=$(python -c 'from setup import dependencies; t = [_ for _ in dependencies if _.startswith("skynetvdf")][0]; print(t)')
...
if [ -e "$THE_PATH" ]; then
	...
	if [ -e venv/bin/python ] && test $UBUNTU_DEBIAN; then
		echo "Installing skynetvdf from source on Ubuntu/Debian"
		...
		echo venv/bin/python -m pip install --extra-index-url https://pypi.skynet-network.org/v01/ --force --no-binary skynetvdf "$SKYNETVDF_VERSION"
		venv/bin/python -m pip install --extra-index-url https://pypi.skynet-network.org/v01/ --force --no-binary skynetvdf "$SKYNETVDF_VERSION"
		symlink_vdf_bench "$PYTHON_VERSION"
	elif [ -e venv/bin/python ] && test $RHEL_BASED; then
		echo "Installing skynetvdf from source on RedHat/CentOS/Fedora"
		# Install remaining needed development tools - assumes venv and prior run of install.sh
		...
		echo "Installing skynetvdf requirement boost for MacOS."
		brew install boost
		echo "Installing skynetvdf from source."
...
................................................................................
................................................................................
.................   To estimate a timelord on this CPU try   ...................
...........   './vdf_bench square_asm 400000' for an ips estimate   ............
................................................................................
"

...
dependencies = [
    ...
    "skynetvdf==1.0.2",  # timelord and vdf verification
    "skynetbip158==1.0",  # bip158-style wallet filters
    "skynetpos==1.0.3",  # proof of space
    "clvm==0.9.7",
    "clvm_rs==0.1.8",
    "clvm_tools==0.4.3",
...
kwargs = dict(
    ...
    author_email="github@skynet-network.org",

...
def calculate_pool_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        ...
        return uint64(int((7 / 8) * 0.5 * _synt_per_skynet))
    elif height < 12 * _blocks_per_year:
        return uint64(int((7 / 8) * 0.25 * _synt_per_skynet))
    else:
        return uint64(int((7 / 8) * 0.125 * _synt_per_skynet))
...
def calculate_base_farmer_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        ...
        return uint64(int((1 / 8) * 0.5 * _synt_per_skynet))
    elif height < 12 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.25 * _synt_per_skynet))
    else:
        return uint64(int((1 / 8) * 0.125 * _synt_per_skynet))

...
class KeyringWrapper:
    ...
    def set_master_passphrase(
        ...
        from skynet.util.keychain import KeyringCurrentPassphraseIsInvalid, KeyringRequiresMigration
    ...
    def migrate_legacy_keys(self) -> MigrationResults:
        from skynet.util.keychain import Keychain, MAX_KEYS
    ...
    def cleanup_legacy_keyring(self, migration_results: MigrationResults):
        ...
        # [skynet_2Duser_2Dskynet_2D1_2E8] is left behind

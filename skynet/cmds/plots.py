...
def show_plots(root_path: Path):
    from skynet.plotting.plot_tools import get_plot_directories

    print("Directories where plots are being searched for:")
    print("Note that subdirectories must be added manually")
    print(
        "Add with 'skynet plots add -d [dir]' and remove with"
        + " 'skynet plots remove -d [dir]'"
        + " Scan and check plots with 'skynet plots check'"
    )
    print()
...
def create_cmd(
    ...
    from skynet.plotting.create_plots import create_plots
...
def check_cmd(
    ...
    from skynet.plotting.check_plots import check_plots
...
def add_cmd(ctx: click.Context, final_dir: str):
    from skynet.plotting.plot_tools import add_plot_directory
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from skynet.plotting.plot_tools import remove_plot_directory

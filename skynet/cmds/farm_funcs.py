...
from skynet.util.misc import format_minutes
from skynet.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total skynet farmed: {amounts['farmed_amount'] / units['skynet']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['skynet']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['skynet']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'skynet start wallet' and 'skynet wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'skynet wallet show'")
    else:
        print("Note: log into your key using 'skynet wallet show' to see rewards for each key")

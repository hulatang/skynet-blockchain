...
from skynet.harvester.harvester import Harvester
from skynet.plotting.plot_tools import PlotInfo, parse_plot_info
from skynet.protocols import harvester_protocol
from skynet.protocols.farmer_protocol import FarmingInfo
from skynet.protocols.harvester_protocol import Plot
from skynet.protocols.protocol_message_types import ProtocolMessageTypes
from skynet.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSSkynetConnection
    ):
        """

...
from skynet.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from skynet.types.blockchain_format.vdf import VDFProof
